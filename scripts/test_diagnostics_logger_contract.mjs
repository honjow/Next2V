...
assert(shareMethod.includes('title: file.fileName'), 'shareDiagnosticsLogFile must expose the selected safe diagnostics filename as share title')
...
assert(sharedDataBlock.includes('title: file.fileName'), 'diagnostics share metadata title must use the selected timestamped filename')
assert(!sharedDataBlock.includes("title: 'Next2V Diagnostics'"), 'diagnostics share metadata title must not use a fixed app title')
assert(sharedDataBlock.includes('label: file.fileName'), 'diagnostics share metadata label must use the selected timestamped filename')

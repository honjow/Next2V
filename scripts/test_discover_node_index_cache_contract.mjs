...
mustContain(discoverPage, '节点导航', 'Discover node section title should be node navigation')
...
mustContain(apiService, "section.title === '最热节点' || section.title === '最近新增节点'", 'home navigation must only contribute first two sections')
mustContain(apiService, "section.title !== '节点导航' && section.title !== 'V2EX / Curated Nodes'", 'structured navigation must drop wrapper/duplicate labels')
...
mustContain(nodeParser, "return '最热节点'", 'Hottest Nodes title should be localized')
